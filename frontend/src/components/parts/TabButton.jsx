...
export default function TabButton( ){
    ...
    // Event handler to update the selected value when the user selects an option
    ...
    return (
    //   <li onClick={()=>{click()}} className="list-none text-base font-bold">
    //   <button  
    //   className=" w-full"><p className="text-center py-[20px] hover:bg-gray-300">{children}</p></button>
    //   </li>
    <div className="relative h-10 w-72 min-w-[200px] mt-[30px] mx-auto">
    <select
