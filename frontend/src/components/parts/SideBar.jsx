...
const SideBar = () => {
  return ( 
   ...
   <div className="h-full px-3 py-4 overflow-y-auto bg-[#fbe5ba] dark:bg-gray-800">
      <ul className="space-y-2 font-medium ">
         <li>
            <Link to="/" className="flex items-center p-2 text-gray-900 rounded-lg bg-[#ffd6a4] dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
